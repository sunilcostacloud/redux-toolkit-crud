...
export const getEmployeeProfile = (state) =>
  state.employees.employeeProfileData;
export const employeeProfileLoading = (state) =>
  state.employees.employeeProfileIsLoading;
export const employeeProfileErrorStatus = (state) =>
  state.employees.employeeProfileIsError;
export const employeeProfileError = (state) =>
  state.employees.employeeProfileError;
export const employeeProfileSuccess = (state) =>
  state.employees.employeeProfileIsSuccess;

// add employee
export const addEmployeeData = (state) => state.employees.employeeAddedData;
export const addEmployeeLoading = (state) =>
  state.employees.employeeAddDataLoading;
export const addEmployeeErrorStatus = (state) =>
  state.employees.employeeAddedDataIsError;
export const addEmployeeError = (state) =>
  state.employees.employeeAddedDataError;
export const addEmployeeSuccess = (state) =>
  state.employees.employeeAddedDataIsSuccess;

// edit employee
export const editEmployeeData = (state) => state.employees.employeeEditedData;
export const editEmployeeLoading = (state) =>
  state.employees.employeeEditDataLoading;
export const editEmployeeErrorStatus = (state) =>
  state.employees.employeeEditDataIsError;
export const editEmployeeError = (state) =>
  state.employees.employeeEditDataError;
export const editEmployeeSuccess = (state) =>
  state.employees.employeeEditDataIsSuccess;

// delete employee
export const deletedEmployeeData = (state) =>
  state.employees.employeeDeletedData;
export const deleteEmployeeLoading = (state) =>
  state.employees.employeeDeleteDataLoading;
export const deleteEmployeeErrorStatus = (state) =>
  state.employees.employeeDeleteDataIsError;
export const deleteEmployeeError = (state) =>
  state.employees.employeeDeleteDataError;
export const deleteEmployeeSuccess = (state) =>
  state.employees.employeeDeleteDataIsSuccess;
